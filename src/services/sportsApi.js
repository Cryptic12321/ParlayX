...
const transformGame = (apiGame, sport) => {
    try {
        ...
        const status = hoursUntilStart <= 3 && hoursUntilStart >= -3 ? 'live' : 'upcoming';
...
export const fetchGamesForSport = async (sport) => {
...
export const fetchAllGames = async (sports) => {
    const allGames = [];
