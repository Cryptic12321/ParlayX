...
interface WalletContextType {
  balance: number
  usdcBalance: number
  deposit: (amount: number, currency: 'SOL' | 'USDC') => Promise<void>
  withdraw: (amount: number, currency: 'SOL' | 'USDC') => Promise<void>
...
export function WalletProvider({ children }: { children: ReactNode }) {
  ...
  const deposit = async (amount: number, currency: 'SOL' | 'USDC') => {
  ...
  const withdraw = async (amount: number, currency: 'SOL' | 'USDC') => {
